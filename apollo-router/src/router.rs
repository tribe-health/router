...
use crate::orbiter::OrbiterAbstractRouterServiceFactory;
...
async fn make_transport_service<RF>(
    ...
    let service_factory = YamlSupergraphServiceFactory::default()
...
impl RouterHttpServer {
    ...
    fn start(
        ...
        let router_factory =
            OrbiterAbstractRouterServiceFactory::new(YamlSupergraphServiceFactory::default());
